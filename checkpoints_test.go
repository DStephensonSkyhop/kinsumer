...
func TestCheckpointer(t *testing.T) {
	...
	cp, err := Capture("shard", table, mock, "ownerName", "ownerId", 3*time.Minute, stats, l)
	...
	cp2, err := Capture("shard", table, mock, "differentOwner", "differentOwnerId", 3*time.Minute, stats, l)
	if err != nil {
